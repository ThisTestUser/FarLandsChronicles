Our journey starts off in 1.16.5, with the Abyss II mod. The first dimension we will visit is the frost world biome.
...
The next destination is a merger of three mods: The Endergetic Expansion, Better End (Forge), and the Outer End. Since the far lands here only generate up to 128 blocks, lots of structures can be found on top of them.
...
In the corner far lands, the terrain looks almost the same as it would without the far lands mod.
...
To end off our 1.17.1 journey, let's explore the end, where the Nullscape datapack is active.

The first thing you'll realize is that the end far lands actually start at 8/7 times the usual distance, at approximately 14,343,795 blocks out. The terrain also looks blocky, much like the Caves & Cliffs far lands.

![Nullscape1](https://raw.githubusercontent.com/ThisTestUser/FarLandsChronicles/master/assets/Ch7/Nullscape1.png)

In the corner far lands, surface features generate everywhere, even in the middle of the stack.

![Nullscape2](https://raw.githubusercontent.com/ThisTestUser/FarLandsChronicles/master/assets/Ch7/Nullscape2.png)

The top of the far lands appears rounded, although still blocky at some parts. The terrain extends up to Y=191 and extends down to Y=-96, which is the build height floor.

![Nullscape3](https://raw.githubusercontent.com/ThisTestUser/FarLandsChronicles/master/assets/Ch7/Nullscape3.png)

The stack in the corner far lands can be very thin, leading to chorus plants generating through layers.

![Nullscape4](https://raw.githubusercontent.com/ThisTestUser/FarLandsChronicles/master/assets/Ch7/Nullscape4.png)
...
Despite this, surface features still work with the terrain generation. Depicted below is the sandstone valley biome, which because of the falling sand crashes the world after a while.
...
However, some aquifers don't generate with air pockets. When this happens, the cave is entirely submerged. Below is an image of a submerged cave at 15 million, 15 million (the image was taken inside a block, which removes the water overlay).
